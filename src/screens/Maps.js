...
import { getMitra } from '../publics/redux/actions/mitra';

class MapsAll extends Component {
    constructor(props) {
        super(props);
        this.state = {
            mitra: [],
    ...
    async componentDidMount() {
        ...
        await this.props.dispatch(getMitra());
        this.setState({
...
export default connect(mapStateToProps)(MapsAll);
